...
public class QuizSimulatorMain {
	...
	private HashMap<Integer, QuizTester> testers;
	...
	public QuizSimulatorMain() {
		...
		this.quizzes = new HashMap<Integer, Quiz>();
		this.testers = new HashMap<Integer, QuizTester>();
	}
	...
	public void handleCreateQuestion(int id, boolean answer, String prompt) {
		Question q = new Question(answer, prompt);
	...
	public void handleAddQuestionToQuiz(int questionId, int quizId ) {
		this.quizzes.get(quizId).addQuestion(questionId, this.questions.get(questionId));
	}
	/**
	...
	public void handleUpdateQuestion(int questionId, boolean answer, String prompt) {
		this.questions.get(questionId).updateQuestion(answer, prompt);
	}
	/**
	 * 
	...
	public String handleGetQuizString(int quizId) {
		return this.quizzes.get(quizId).toString(quizId);
	}
	/**
	...
	public void handleCreateQuizTester(int id, String searchString) {
		QuizTester t = new QuizTester(searchString);
		this.testers.put(id,t);
	}
	/**
	...
	public double handleGetQuizTesterScoreOnQuiz( int quizTesterId, int quizId) {
		return this.testers.get(quizTesterId).getScore(this.quizzes.get(quizId));
	}
	/**
	...
	public double handleGetQuizTesterOverallScore( int quizTesterId) {
		return this.testers.get(quizTesterId).getAllScore(this.quizzes);
	}
