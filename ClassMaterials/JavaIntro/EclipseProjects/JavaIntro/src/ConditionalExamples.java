...
public class ConditionalExamples {
	...
	public static void guessCubeRoot(double number, double guess) {
		Double check= Math.pow(guess, 3);
		if(check>number) {System.out.println("higher");}
		else if (check<number) {System.out.println("Lower");}
		else if (check==number) {System.out.println("Perfect:);}
	}
